...
const faqData: Record<string, { question: string; answer: string }[]> = {
  ...
  "/web-design": [
    ...
    { question: "Will you still be there if something breaks in two years?", answer: "Yes. Care plans and managed IT are how the business is set up \u2014 recurring relationships are the main work, not the exception. My longest single client relationship ran nine years before naturally concluding; my longest active client relationship is going on four years and counting. Documentation, credentials, and runbooks are written down \u2014 continuity is built into the operating model." },
    { question: "Why not just hire a cheaper website studio?", answer: "If all you need is a one-page brochure site that nobody will maintain, a cheaper option is fine. If you need a website that ranks, complies, integrates with your email and IT, and has someone available in two years to fix what breaks \u2014 a website studio is not the right fit and a Crettyard Digital site is. Genuine answer either way \u2014 I\u2019ll tell you which I think you need." },
  ],
  "/microsoft-365": [
