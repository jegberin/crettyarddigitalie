...
import { CheckCircle, ArrowRight, ServerCog, Shield, Cloud, Utensils, Briefcase, Wifi } from "lucide-react";
      ...
      <section className="py-28 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <FadeIn>
            ...
            <p className="text-foreground text-[15px] leading-relaxed font-sans mb-6">
              Kilkenny's hospitality sector faces additional pressure from the European Accessibility Act, which requires accessible digital services. Professional firms face GDPR obligations that many haven't fully addressed. Tourism businesses need technology that can handle seasonal peaks without breaking.
            </p>
      ...
      <section className="py-28 bg-[#f3f4f5]">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <StaggerContainer className="grid md:grid-cols-2 gap-8">
            {[
              { icon: Utensils, title: "Hospitality & Tourism", desc: "POS system support, guest Wi-Fi setup and isolation, booking system integration, and compliance with the European Accessibility Act for digital services. Your technology needs to handle Friday evening and August bank holiday peaks without flinching." },
              { icon: Briefcase, title: "Professional Firms", desc: "Secure Microsoft 365 with GDPR-compliant data handling, encrypted email, and proper document management. Solicitors, accountants, and consultants in Kilkenny need IT that protects client confidentiality and meets regulatory requirements." },
              { icon: Wifi, title: "Retail & Craft", desc: "In-store and online technology working together. E-commerce support, inventory systems, payment processing, and reliable connectivity. Kilkenny's craft businesses need technology that supports rather than complicates their work." },
