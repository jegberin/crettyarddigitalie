    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-28 bg-[#f3f4f5]">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <StaggerContainer className="grid md:grid-cols-2 gap-8">
            {[
              { img: iconSecurityAudit, alt: "Glass magnifying glass over a glass checklist representing a security audit and health check", title: "Security Audit & Health Check", desc: "I review your email, devices, network, and cloud accounts against Cyber Essentials baselines. You get a plain-English report showing what\u2019s at risk and what to fix first.", price: "Quoted on request" },
              { img: iconMfaPadlock, alt: "Glass padlock representing multi-factor authentication and account security", title: "Multi-Factor Authentication (MFA)", desc: "The single most effective thing any business can do. I configure MFA (phishing-resistant FIDO2 / passkeys where it matters) across Microsoft 365, email, and critical accounts.", price: "Quoted on request" },
              { img: iconEmailShield, alt: "Glass envelope with a glass shield representing email security hardening", title: "Email Security Hardening", desc: "Advanced phishing protection via Microsoft Defender for Office 365, spam filtering, and email authentication (SPF, DKIM, DMARC) \u2014 stops criminals sending emails that look like they came from you.", price: "Quoted on request" },
              { img: iconTraining, alt: "Glass lightbulb with a glass speech bubble representing staff cyber awareness training", title: "Staff Cyber Awareness Training", desc: "Over 90% of attacks start with a human mistake. Practical, jargon-free training so your team spots phishing and social engineering.", price: "Quoted on request" },
      ...
      <section className="py-28 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <StaggerContainer className="grid md:grid-cols-2 gap-8">
            {[
              { title: "Web Compliance Audit", desc: "Comprehensive check of your website for GDPR (forms, data collection, privacy policy), cookie consent (ePrivacy), and accessibility (EAA / WCAG). Plain-English report with prioritised fixes.", price: "Quoted on request" },
              { title: "IT Resilience Audit", desc: "Check of your network and Microsoft 365 setup against NIS2 standards (and DORA, where applicable). Identifies gaps and provides a clear remediation plan.", price: "Quoted on request" },
              { title: "Cookie Consent Setup", desc: "Proper Consent Management Platform implementation so your website only loads tracking cookies after explicit user consent.", price: "Quoted on request" },
              { title: "Accessibility Audit & Remediation", desc: "Full audit of your website against EAA / WCAG standards, with a prioritised fix list. I can implement all fixes too.", price: "Quoted on request" },
              { title: "NIS2 Readiness Package", desc: "Bundled assessment covering network security, M365 hardening, MFA, incident response planning, backup verification, and documentation.", price: "Quoted on request" },
              { title: "DORA Readiness (Financial Sector)", desc: "For credit unions, insurance firms, investment firms, and other regulated financial entities \u2014 ensures your IT meets the operational resilience standards DORA requires. Includes scope review if you\u2019re unsure whether DORA applies to you.", price: "Quoted on request" },
            ].map((item, i) => (
              <StaggerItem key={i}>
