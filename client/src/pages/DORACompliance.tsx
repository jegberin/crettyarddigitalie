        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10">
          <FadeIn direction="up">
            ...
            <h1 className="display-heading text-white mb-6 leading-tight">
              DORA Is Here. If You Work in Financial Services, Your IT Needs to Be Ready.
            </h1>
            <p className="text-lg md:text-xl text-white/80 max-w-2xl mb-8">
              The Digital Operational Resilience Act (DORA) applies to regulated financial entities &mdash; banks, credit unions, investment firms, insurance undertakings and intermediaries, pension funds, and similar. If your firm is one of these entities, your technology now needs to meet banking-grade operational resilience standards. I help you get there &mdash; without the complexity.
            </p>
            ...
            <FadeIn>
              <div className="bg-[#f3f4f5] p-7 rounded-2xl">
                ...
                <ul className="space-y-2.5">
                  {["Banks and credit unions", "Payment institutions and e-money institutions", "MiFID-regulated investment firms", "Insurance and reinsurance undertakings", "Insurance and reinsurance intermediaries", "Pension funds (IORPs)", "Investment fund managers (AIFMs, UCITS)", "Crypto-asset service providers"].map((item, i) => (
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <StaggerContainer className="grid sm:grid-cols-2 md:grid-cols-5 gap-4">
            {[
              ...
              { num: "03", icon: FileCheck, title: "Resilience Testing", desc: "Regular testing of IT systems to ensure they withstand disruptions." },
      ...
      <section className="py-28 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <StaggerContainer className="grid md:grid-cols-2 gap-8">
            {[
              { title: "DORA Readiness Assessment", price: "From \u20ac400", desc: "I review your current IT infrastructure against DORA requirements and deliver a plain-English report showing where you comply, where the gaps are, and what needs to change. Prioritised by urgency and cost." },
              { title: "DORA-Aligned IT Setup", price: "Quoted on scope", desc: "If you need a new or upgraded IT environment, I build it to DORA standards from the start \u2014 Microsoft 365 with advanced security, encrypted communications, automated backups with tested recovery, endpoint protection, and full documentation." },
              { title: "Ongoing Compliance Management", price: "Included in Comprehensive plan", desc: "As part of a Comprehensive Managed IT plan, DORA compliance monitoring is included \u2014 not an add-on. I keep your systems aligned with requirements as regulations evolve." },
              { title: "Audit-Ready Documentation", price: "Included with assessments", desc: "When a financial regulator, auditor, or corporate client asks to see evidence of your IT resilience, you have it \u2014 clear, current, and comprehensive." },
            ].map((item, i) => (
              <StaggerItem key={i}>
          ...
          <FadeIn>
            <Accordion type="single" collapsible className="w-full space-y-3">
              {[
                ...
                { id: "d-4", q: "What does a DORA readiness assessment involve?", a: "I review your current IT setup \u2014 email security, backup systems, network configuration, endpoint protection, access controls, and incident response capabilities \u2014 against DORA\u2019s requirements. You get a prioritised report showing what\u2019s compliant, what needs fixing, and what it will cost." },
                { id: "d-5", q: "How long does it take to become DORA-ready?", a: "It depends on your current setup. Some firms are already close and just need documentation and a few configuration changes. Others may need more significant upgrades. I\u2019ll give you a realistic timeline after the initial assessment." },
              ].map((faq) => (
