...
const services: Service[] = [
  ...
  },
  {
    ...
    desc: "Productised endpoint security and a leased managed firewall, plus bespoke compliance projects \u2014 NIS2, GDPR, DORA, and the European Accessibility Act. Audit-grade evidence built in, not bolted on.",
    price: "Endpoint from \u20ac50/user/month \u00b7 Firewall \u20ac150/month",
    href: "/cybersecurity",
